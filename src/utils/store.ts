...
export class ReplStore implements Store {
  ...
  constructor({
    serializedState = '',
    defaultVueRuntimeURL = 'https://unpkg.com/@vue/runtime-dom@3.2.8/dist/runtime-dom.esm-browser.js',
    defaultVueServerRendererURL = 'https://unpkg.com/@vue/server-renderer@3.2.8/dist/server-renderer.esm-browser.js',
    showOutput = false,
    outputMode = 'preview',
  }: StoreOptions = {}) {
  ...
  resetVueVersion() {
    ...
    this.setImportMap(importMap)
    this.forceSandboxReset()
    console.info('Now using default Vue version')
  }
}
